...
def data_input(filename,SCoupon,mm):
...
job_server = pp.Server(10,ppservers=ppservers, secret="123456")  
...
if __name__ == '__main__':
    ...
    jobs = [job_server.submit(data_input, ('..\\MillionData\\mdata'+str(i)+'.json',SCoupon,mm,), (get_yields,), ('json',),globals=globals()) for i in list]
